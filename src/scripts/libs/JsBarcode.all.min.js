					...
					u(e, [
						{
							key: "valid",
							value: function () {
								return new RegExp("^" + c.A_CHARS + "+$").test(
									this.data
								);
							},
						},
					...
					u(e, [
						{
							key: "valid",
							value: function () {
								return new RegExp("^" + c.B_CHARS + "+$").test(
									this.data
								);
							},
						},
					...
					u(e, [
						{
							key: "valid",
							value: function () {
								return new RegExp("^" + c.C_CHARS + "+$").test(
									this.data
								);
							},
						},
				...
				return (
					...
					a(e, [
						...
						},
						{
							...
							value: function () {
								var t =
									f.EAN2_STRUCTURE[parseInt(this.data) % 4];
								return {
									data:
										"1011" +
										(0, s.default)(this.data, t, "01"),
									text: this.text,
								};
							},
						},
		...
		var u = (function () {
			...
			c = (function (t) {
				function e(t, n) {
					...
					return (
						(i.text =
							i.options.text || i.text.replace(/[A-D]/g, "")),
						i
					);
				}
				return (
				...
				return (
					...
					u(e, [
						...
						},
						{
							...
							value: function () {
								return (
									this.number >= 3 && this.number <= 131070
								);
							},
						},
					]),
					...
					o(t, [
						...
						},
						{
							...
							value: function () {
								...
								var e = (0, a.getTotalWidthOfEncodings)(
										this.encodings
									),
									n = (0, a.getMaximumHeightOfEncodings)(
										this.encodings
									);
								(this.canvas.width =
									e +
					...
					o(t, [
						...
						},
						{
							...
							value: function () {
								...
								var t = (0, a.getTotalWidthOfEncodings)(
										this.encodings
									),
									e = (0, a.getMaximumHeightOfEncodings)(
										this.encodings
									),
									n =
										t +
